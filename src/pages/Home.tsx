          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {servicesData.map((service, index) => <AnimatedElement key={service.title} animation="slide-up" delay={index * 100}>
                <div className="bg-white rounded-lg p-8 shadow-sm hover-scale h-full flex flex-col">
                  ...
                  <Link to={service.link} className="inline-flex items-center text-furi-red font-medium hover:underline">
        ...
        <div className="container mx-auto px-6">
          ...
          <AnimatedElement animation="fade-in" delay={200}>
            <div className="flex flex-wrap justify-center gap-4">
              {industriesData.map(industry => <Link key={industry} to="/industries" className="bg-gray-50 hover:bg-gray-100 px-6 py-3 rounded-md text-gray-800 transition-colors">
                  {industry}
                </Link>)}
            </div>
          </AnimatedElement>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <AnimatedElement animation="fade-in">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Introducing SmartCampaigns</h2>
                ...
                <Link to="/services#smart-campaigns" className="inline-block bg-furi-red text-white px-8 py-3 rounded-md font-medium hover:bg-opacity-90 transition-all">
                  Learn More
                </Link>
              </AnimatedElement>
            </div>
