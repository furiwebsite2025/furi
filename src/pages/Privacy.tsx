  ...
  return (
    <div className="pt-20 sm:pt-24 md:pt-28">
      <section className="py-10 sm:py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <AnimatedElement animation="fade-in">
            <SectionHeading title="Privacy Notice" subtitle="Last updated April 14, 2025" />
          </AnimatedElement>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto prose prose-sm sm:prose lg:prose-lg">
            <AnimatedElement animation="fade-in">
              <p>This Privacy Notice for Furi Media Services ('we', 'us', or 'our'), describes how and why we might collect, store, use, and/or share ('process') your personal information when you use our services ('Services'), including when you:</p>
              <ul>
                <li>Visit our website at <a href="http://www.furiglobal.in">http://www.furiglobal.in</a>, or any website of ours that links to this Privacy Notice</li>
              ...
              <h2 className="text-2xl font-bold mt-8">TABLE OF CONTENTS</h2>
              ...
              <ol>
                ...
                <li><a href="#section5">DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</a></li>
              ...
              <h2 id="section1" className="text-2xl font-bold mt-8">1. WHAT INFORMATION DO WE COLLECT?</h2>
              
              <h3 className="text-xl font-bold mt-6">Personal information you disclose to us</h3>
              ...
              <h3 className="text-xl font-bold mt-6">Information automatically collected</h3>
              ...
              <h2 id="section2" className="text-2xl font-bold mt-8">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
              ...
              <h2 id="section3" className="text-2xl font-bold mt-8">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
              ...
              <h2 id="section4" className="text-2xl font-bold mt-8">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
              ...
              <h2 id="section5" className="text-2xl font-bold mt-8">5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</h2>
              ...
              <h3 className="text-xl font-bold mt-6">Our AI Products</h3>
              ...
              <h3 className="text-xl font-bold mt-6">How We Process Your Data Using AI</h3>
              ...
              <h2 id="section6" className="text-2xl font-bold mt-8">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
              ...
              <h2 id="section7" className="text-2xl font-bold mt-8">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
              ...
              <h2 id="section8" className="text-2xl font-bold mt-8">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
              
              <p><em>In Short: We do not knowingly collect data from or market to children under 18 years of age.</em></p>
              
              <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at admin@furiglobal.in.</p>
              
              <h2 id="section9" className="text-2xl font-bold mt-8">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
              ...
              <p>If you have questions or comments about your privacy rights, you may email us at admin@furiglobal.in.</p>
              
              <h2 id="section10" className="text-2xl font-bold mt-8">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
              ...
              <h2 id="section11" className="text-2xl font-bold mt-8">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
              ...
              <h2 id="section12" className="text-2xl font-bold mt-8">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
              
              <p>If you have questions or comments about this notice, you may email us at admin@furiglobal.in or contact us by post at:</p>
              ...
              <h2 id="section13" className="text-2xl font-bold mt-8">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
