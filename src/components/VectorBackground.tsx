  ...
  return (
    <div className={cn("absolute inset-0 overflow-hidden z-0", className)}>
      <div className="absolute inset-0">
        {/* Animated vectors - increased size and opacity for visibility */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-furi-red/20 rounded-full blur-3xl animate-pulse" />
        ...
        {/* Vector patterns - increased opacity */}
